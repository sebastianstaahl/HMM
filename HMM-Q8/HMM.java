...
//noint.nextInt()
	...
	public HMM() {
		...
		transitionMatrix = new double [][]{{0.6, 0.15, 0.25}, {0.25, 0.6, 0.15}, {0.15, 0.25, 0.6}};
		transitionMatrixCorrect = new double [][] {{0.7, 0.05, 0.25}, {0.1, 0.8, 0.1}, {0.2, 0.3, 0.5}};


		//String line2=input.nextLine();
		 emissionMatrix = new double [][]{{0.55, 0.2 , 0.15, 0.1}, {0.24, 0.21, 0.23, 0.29}, {0.15, 0.2, 0.15, 0.5}};
		 emissionMatrixCorrect = new double[][]{{0.7, 0.2 , 0.1, 0}, {0.1, 0.4, 0.3, 0.2}, {0, 0.1, 0.2, 0.7}};


		//String line3=input.nextLine();
		 initialStateProb = new double[]{0.33, 0.35, 0.32};
